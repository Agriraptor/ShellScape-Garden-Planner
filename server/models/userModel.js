...
const pool = new Pool({
  connectionString: process.env.PG_URI, // Using a full connection string if available
  ssl: {
    rejectUnauthorized: false // This may be necessary if using self-signed certificates
  }
});
...
// We export an object that contains a property called query,
// which is a function that handles the invocation of pool.query()
module.exports = {
